...
<div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-green-500 text-white p-4 rounded-lg shadow-md flex justify-between items-center">
            <div>
                <h5 class="text-lg">Total Pendapatan</h5>
                <p class="text-2xl font-bold">Rp{{ number_format($keuntungan, 0, ',', '.') }}</p>
            </div>
            <i class="fa-solid fa-money-bill-wave text-4xl opacity-60"></i>
        </div>
    </div>
